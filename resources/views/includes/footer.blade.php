...
<footer class="container">
  ...
  @endif
    <div class="col-md-3">
      ...
      <ul class="list-unstyled">
        <li><a class="link-footer" href="{{url('creators')}}">{{trans('general.explore_creators')}}</a></li><li>
      @guest
        ...
        @endif
        @else
          <li><a class="link-footer" href="{{ url('settings') }}">{{ trans('users.account_settings') }}</a></li><li>
