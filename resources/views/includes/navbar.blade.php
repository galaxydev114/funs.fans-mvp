			...
			@else
					...
					<li class="nav-item dropdown">
						<a class="nav-link px-2" href="{{url('/')}}">
							<img src="{{url('public/img/icons/home.svg')}}" width="23" />
					...
					<li class="nav-item dropdown">
						<a class="nav-link px-2" href="{{url('creators')}}">
							<img src="{{url('public/img/icons/compass.svg')}}" width="23" />
				...
				<li class="nav-item dropdown">
					<a href="{{url('messages')}}" class="nav-link px-2">
						...
						<img src="{{url('public/img/icons/paper.svg')}}" width="23" />
				...
				<li class="nav-item dropdown">
					<a href="{{url('notifications')}}" class="nav-link px-2">
						...
						<img src="{{url('public/img/icons/bell.svg')}}" width="23" />
