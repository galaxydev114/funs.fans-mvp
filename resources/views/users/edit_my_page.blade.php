          ...
          <div class="form-group">
            ...
            <div class="input-group-prepend">
              <span class="input-group-text">{{$settings->currency_symbol}}</span>
                ...
                <input class="form-control form-control-lg" @if (Auth::user()->verified_id == 'no') disabled @endif name="price" placeholder="{{trans('users.subscription_price')}}" value="{{Auth::user()->price}}"  type="text">
            </div>
